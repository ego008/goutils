...
func sFilter[S ~[]E, E any](s S, f func(int, E) bool) S {
	r := make(S, 0)
...
func sMap[S ~[]E, E any, U any](s S, f func(int, E) U) []U {
	r := make([]U, len(s))
...
func sReduce[S ~[]E, E any, U any](s S, init U, f func(int, E, U) U) U {
	r := init
